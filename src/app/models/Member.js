...
module.exports = {
    ...
    create(data, callback) {
        ...
        const query = `
            INSERT INTO members(avatar_url, name, email, birth, gender, blood, weigth, heigth, instructor_id)
    ...
    update(data, callback) {
        ...
        const query = `
        UPDATE members SET avatar_url=($1), name=($2), email=($3), birth=($4), gender=($5) , blood=($6), weigth=($7), heigth=($8), instructor_id=($9)
        WHERE id = $10
        `
